...
import { OFFICE_VENDOR_MAP, OFFICE_CAT_MAP, getCatLabel, formatDate, apiOffice, apiClicks } from '../../api/index.js'
...
.office-desc{font-size:14px;color:#64748b;line-height:1.5;margin:0 0 6px;text-indent:2em;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
