...
@media(max-width:640px){.home-title{font-size:28px}.home-subtitle{font-size:15px}.home-grid{grid-template-columns:1fr}.stats-cards{grid-template-columns:repeat(2,1fr)}.stats-row{grid-template-columns:1fr}.module-top10-row{grid-template-columns:1fr}.vertical-chart-container{height:160px;gap:8px}.vertical-chart-fill{width:32px}.vertical-chart-label{font-size:10px}}
</style>
